...
class GetsControllerTest < ActionController::TestCase
  ...
  test "should create get" do
    assert_difference('Get.count') do
      post :create, get: { date: @get.date, name: @get.name, of: @get.of, trip: @get.trip, trip: @get.trip, type: @get.type }
    end
  ...
  test "should update get" do
    patch :update, id: @get, get: { date: @get.date, name: @get.name, of: @get.of, trip: @get.trip, trip: @get.trip, type: @get.type }
    assert_redirected_to get_path(assigns(:get))
  end
